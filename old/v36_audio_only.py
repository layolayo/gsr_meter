...
def log_msg(msg):
    ...
    if 'ui_refs' in globals() and 'log_text' in ui_refs:
        try: ui_refs['log_text'].set_text(clean_msg)
        except: pass
...
if __name__ == "__main__":
    ...
    # [FIX] Create Transparent Overlay Axes for Full-Screen Text (Required for Blit=True)
    ...
    ax_info = reg_ax(r_info, settings_view_axes)
